                      ...
                      Stack(alignment: Alignment.topCenter, children: [
                        ...
                        StreamBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              final card = snapshot.data;
                              if (!snapshot.hasData) {
                                return this.oberklasse.kartenStapel3.length >=
                                        10
                                    ? Positioned(
                                        top: 270,
                                        child: Container(
                      ...
                      Stack(alignment: Alignment.topCenter, children: [
                        ...
                        StreamBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              final card = snapshot.data;
                              if (!snapshot.hasData) {
                                return this.oberklasse.kartenStapel4.length >= 5
                                    ? Positioned(
                                        top: 120,
                                        child: Container(
                                          width: 100,
                        ...
                        StreamBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              final card = snapshot.data;
                              if (!snapshot.hasData) {
                                return this.oberklasse.kartenStapel4.length >= 6
                                    ? Positioned(
                                        top: 150,
                                        child: Container(
                                          width: 100,
                        ...
                        StreamBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              final card = snapshot.data;
                              if (!snapshot.hasData) {
                                return this.oberklasse.kartenStapel4.length >= 7
                                    ? Positioned(
                                        top: 180,
                                        child: Container(
                                          width: 100,
                        ...
                        StreamBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              final card = snapshot.data;
                              if (!snapshot.hasData) {
                                return this.oberklasse.kartenStapel4.length >=
                                        10
                                    ? Positioned(
                                        top: 270,
                                        child: Container(
                      ...
                      Stack(alignment: Alignment.topCenter, children: [
                        ...
                        StreamBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              final card = snapshot.data;
                              if (!snapshot.hasData) {
                                return this.oberklasse.kartenStapel5.length >= 6
                                    ? Positioned(
                                        top: 150,
                                        child: Container(
                                          width: 100,
                        ...
                        StreamBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              final card = snapshot.data;
                              if (!snapshot.hasData) {
                                return this.oberklasse.kartenStapel5.length >= 7
                                    ? Positioned(
                                        top: 180,
                                        child: Container(
                                          width: 100,
                        ...
                        StreamBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              final card = snapshot.data;
                              if (!snapshot.hasData) {
                                return this.oberklasse.kartenStapel5.length >=
                                        10
                                    ? Positioned(
                                        top: 270,
                                        child: Container(
                      ...
                      Stack(alignment: Alignment.topCenter, children: [
                        ...
                        StreamBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              final card = snapshot.data;
                              if (!snapshot.hasData) {
                                return this.oberklasse.kartenStapel6.length >= 7
                                    ? Positioned(
                                        top: 180,
                                        child: Container(
                                          width: 100,
                        ...
                        StreamBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              final card = snapshot.data;
                              if (!snapshot.hasData) {
                                return this.oberklasse.kartenStapel6.length >=
                                        10
                                    ? Positioned(
                                        top: 270,
                                        child: Container(
                      ...
                      Stack(alignment: Alignment.topCenter, children: [
                              ...
                              return Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child: Image.asset(card.getDateiame()),
                                  ),
                                ),
                              );
                            }),
                        ...
                        StreamBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              final card = snapshot.data;
                              if (!snapshot.hasData) {
                                return this.oberklasse.kartenStapel7.length >=
                                        10
                                    ? Positioned(
                                        top: 270,
                                        child: Container(
